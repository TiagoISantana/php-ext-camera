srcdir = /home/tiago/PhpstormProjects/php-ext-camera
builddir = /home/tiago/PhpstormProjects/php-ext-camera
top_srcdir = /home/tiago/PhpstormProjects/php-ext-camera
top_builddir = /home/tiago/PhpstormProjects/php-ext-camera
EGREP = /usr/bin/grep -E
SED = /usr/bin/sed
AWK = nawk
SHLIB_SUFFIX_NAME = so
SHLIB_DL_SUFFIX_NAME = so
shared_objects_camera = camera.lo
PHP_PECL_EXTENSION = camera
LIBS = -ljpeg -lstdc++
PHP_MODULES = $(phplibdir)/camera.la
PHP_ZEND_EX =
...
INSTALL_HEADERS =
BUILD_CC = cc
phplibdir = /home/tiago/PhpstormProjects/php-ext-camera/modules
...
-include camera.dep
camera.lo: /home/tiago/PhpstormProjects/php-ext-camera/camera.c
	$(LIBTOOL) --tag=CC --mode=compile $(CC) -I. -I/home/tiago/PhpstormProjects/php-ext-camera $(COMMON_FLAGS) $(CFLAGS_CLEAN) $(EXTRA_CFLAGS)   -DZEND_COMPILE_DL_EXT=1 -c /home/tiago/PhpstormProjects/php-ext-camera/camera.c -o camera.lo  -MMD -MF camera.dep -MT camera.lo
$(phplibdir)/camera.la: ./camera.la
	$(LIBTOOL) --tag=CC --mode=install cp ./camera.la $(phplibdir)

./camera.la: $(shared_objects_camera) $(CAMERA_SHARED_DEPENDENCIES)
	$(LIBTOOL) --tag=CC --mode=link $(CC) -shared $(COMMON_FLAGS) $(CFLAGS_CLEAN) $(EXTRA_CFLAGS) $(LDFLAGS)  -o $@ -export-dynamic -avoid-version -prefer-pic -module -rpath $(phplibdir) $(EXTRA_LDFLAGS) $(shared_objects_camera) $(CAMERA_SHARED_LIBADD)
